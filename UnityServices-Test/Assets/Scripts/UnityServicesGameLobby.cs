...
public class UnityServicesGameLobby : MonoBehaviour
{
    private const string KEY_RELAY_JOIN_CODE = "RelayJoinCode";

    public static UnityServicesGameLobby Instance { get; private set; }
    ...
    public async void ReconnectToLobby()
    {
        if (joinedLobby != null)
        {
            try
            {
                await LobbyService.Instance.ReconnectToLobbyAsync(joinedLobby.Id);
